...
To publish after review, set `"status": "published"` in the claim file. The directory overlays published claims onto the catalog at read time — do not put `claimedBy` into `data/catalog.json`.
