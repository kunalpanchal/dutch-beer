...
A brewery claim needs a contact email and evidence URL on the official website domain. Consumer mailboxes (Gmail, Outlook, and similar) are not accepted. After review, `"status": "published"` marks the listing as verified. Do not invent a cover, logo, description, hours, or social links.
